...
<head>
<meta charset="UTF-8">
<title>Sustentabilidade - Apoena Biotech</title>
...
<!-- ================= HERO BIOTECH ================= -->
<section class="hero-internal biotech-hero">
  <div class="container">
    <h1>Responsabilidade<br>Social e Ambiental</h1>
  </div>
</section>
...
<img src="/uploads/img/foto_responsabilidade.jpg" class="about-img">
</div>
<div class="col-lg-6 reveal">
<p class="bg-success bg-opacity-10 p-3 border-start border-4 border-success">Como uma empresa que valoriza toda a cadeia de produção sustentável, não incorporamos esse valor apenas em nosso processo, mas também na forma em que nos portamos e conduzimos o dia a dia de nossa companhia. Pensando nisso, temos parcerias e projetos que atingem outras esferas e estão ligadas com a forma da Apoena enxergar o mundo.</p>
</div>
</div>
</div>
</section>
...
<div class="row g-5 align-items-center">
<div class="col-lg-6 reveal">
<img src="/uploads/img/eureciclo2.png" class="about-img">
</div>
<div class="col-lg-6 reveal">
<p class="bg-success bg-opacity-10 p-3 border-start border-4 border-success">Agora, estamos juntos com a eureciclo no investimento na cadeia de reciclagem. Isso significa que geramos um impacto positivo para os trabalhadores do setor, através da reciclagem de materiais equivalentes aos que utilizamos em nossas embalagens.<br>
Há muito trabalho pela frente, mas juntos pensamos no mundo e futuro que queremos preservar.</p><br><br>
<p class="mt-3"><b>Faça parte dessa revolução!</b></p>
</div>
</div>
</div>
</section>
